...
import { FaMap, FaCog, FaUserCircle, FaFire, FaSignOutAlt } from "react-icons/fa";
      ...
      <Container fluid className='ps-5 pe-5'>
        ...
        <BNavbar.Collapse className='justify-content-end align-items-center'>
          ...
          <NavDropdown title={<ProfileImage />} align="end">
            ...
            <NavDropdown.Item className='navbar-dropdown-item' onClick={goToSettings}>
              <FaCog className='navbar-dropdown-item-icon' />Settings
            </NavDropdown.Item>
